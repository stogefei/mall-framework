...
export default class BBaseTree extends Mixins(Popper) {
  ...
  get searchPlaceholder () {
    return i18n.t('genesisUI.searchRole');
  }

  get selectPlaceholder () {
    return i18n.t('genesisUI.selectRole');
  }
            ...
            >
              {this.deptsTreeData.length > 0 ? (
                <a-tree
                  ...
                  selectedKeys={
                    !this.isMultiple || this.selectable
                  ...
                  <div>
                    ...
                    {this.isMultiple ? (
                      <multiple-item
                        class={
                          this.hasLimit
                            ? `${prefix}-content__checkbox--limit`
                            : ''
                        }
