...
import {
  ...
  setTransformRtl,
  setTransform,
} from '../grid-layout/utils/utils';
import {
  getControlPosition,
  createCoreData,
} from '../grid-layout/utils/draggable-utils';
import { getColsFromBreakpoint } from '../grid-layout/utils/responsive-utils';
import { getDocumentDir } from '../grid-layout/utils/dom';
...
export default {
  ...
  computed: {
    classObj () {
      return {
        'bb-grid-item--resizable': this.resizableAndNotStatic,
        static: this.static,
        resizing: this.isResizing,
        'bb-grid-item--dragging': this.isDragging,
    ...
    resizableHandleClass () {
      if (this.renderRtl) {
        return 'bb-resizable-handle bb-rtl-resizable-handle';
      } else {
        return 'bb-resizable-handle';
      }
    },
  },
  watch: {
